    ...
    <section className='my-28' id='contact'>
      ...
      <div className='md:mx-6 flex flex-col flex-wrap md:flex-row justify-between'>
        <div className='md:w-6/12 md:px-0 p-5 my-5'>
          <div>
            <p className='font-bold'>Julio Cesar Mederos Arias</p>
            <p className='font-thin'>Santiago, Chile</p>
            <a href='mailto: Theelipan@gmail.com' className='border-b-2 mt-3 inline-block border-gray-500'>
              juliomederosarias@gmail.com
            </a>
          </div>
          ...
          <div className='flex flex-row flex-wrap mt-7'>
            <div className='mr-4'>
              <a href='https://www.linkedin.com/in/julio-mederos/' target='_blank' rel='noreferrer'>
            ...
            <div className='mr-4'>
              <a href='https://github.com/cesar2k94' target='_blank' rel='noreferrer'>
                <span className='mb-2 flex flex-row items-end border border-gray-500 p-2 rounded-lg text-sm'>
